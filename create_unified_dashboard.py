...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .metric-healthy {{ background: #d1fae5; color: #065f46; font-weight: 600; }}
        .metric-warning {{ background: #fef3c7; color: #92400e; font-weight: 600; }}
        .metric-critical {{ background: #fee2e2; color: #991b1b; font-weight: 600; }}

        .action-badge {{ display: inline-block; padding: 6px 12px; border-radius: 6px; font-size: 11px; font-weight: 700; text-transform: uppercase; }}
        .action-scale {{ background: #d1fae5; color: #065f46; }}
        .action-kill {{ background: #fee2e2; color: #991b1b; }}
        .action-optimize {{ background: #fef3c7; color: #92400e; }}
        .action-monitor {{ background: #e0e7ff; color: #3730a3; }}
